...
function App() {
  ...
  const getWeatherByLocation = (position) => {
    ...
    // axios.get(`http://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=863e83d14307a779468265863efa8899`)
    // .then(res => {
    //   //  setWeather(res.data)
  ...
  return (
    <div className="App">
      <Router>
        <Nav user={user} weather={weather} position={position}/>
